...
<meta name="description" content="Air-Ticket" />
<meta name="keywords" content="Air-Ticket" />
<meta name="author" content="Air-Ticket" />
...
<link rel="stylesheet" href="<?php echo base_url() ?>_assets/font-awesome/css/font-awesome.min.css">
	...
	<header id="fh5co-header-section" class="sticky-banner">
		<div class="container">
			<div class="nav-header">
				...
				<h1 id="fh5co-logo"><a href="<?php echo base_url() ?>"><i class="fa fa-paper-plane"></i>Air-Ticket</a></h1>
...
<div class="fh5co-hero">
	<div class="fh5co-cover" style="background-color: #f6f6f6" data-stellar-background-ratio="0.5">
		<div class="desc">
			<div class="container">
				<div class="row">
