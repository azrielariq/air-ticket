					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="<?php echo base_url() ?>_assets/admin/dist/img/air.png" class="user-image" alt="User Image">
								<!-- hidden-xs hides the username on small devices so only the image appears. -->
								<span class="hidden-xs"><?php echo $this->session->userdata('user_admin')["fullname"] ?></span>
							</a>
							<ul class="dropdown-menu">
								<!-- The user image in the menu -->
								<li class="user-header">
									<img src="<?php echo base_url() ?>_assets/admin/dist/img/air.png" class="img-circle" alt="User Image">

									<p>
                  <?php echo $this->session->userdata('user_admin')["fullname"] ?>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					...
					<div class="pull-left info">
						<p><?php echo $this->session->userdata('user_admin')["fullname"] ?></p>
						<!-- Status -->
						<a href="#">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="<?php echo ($nav == 'setting' ? 'active' : '') ?>">
