  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">Air-Ticket</a>.</strong> Admin Panel.
  </footer>
...
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo base_url() ?>_assets/admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo base_url() ?>_assets/admin/dist/js/adminlte.min.js"></script>
<!-- DataTables -->
